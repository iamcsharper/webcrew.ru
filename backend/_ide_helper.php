 ...
 * Generated for Laravel 5.6.26 on 2018-08-15 12:49:23.
 *
...
namespace Spatie\Ssr\Facades { 
    ...
    class Ssr {
        ...
        {
            return \Spatie\Ssr\Renderer::enabled($enabled);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::disabled($disabled);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::debug($debug);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::entry($entry);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::context($context, $value);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::env($env, $value);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::fallback($fallback);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::resolveEntryWith($entryResolver);
        }
        ...
        {
            return \Spatie\Ssr\Renderer::render();
        }
