        ...
        <transition name="fade">
            <main class="col-md-9 col-sm-12 col-xs-12 left-sidebar pull-right sm-margin-60px-bottom xs-margin-40px-bottom no-padding"
                ...
                <div class="row">
                            ...
                            <ul class="portfolio-grid work-3col hover-option4 gutter-medium">
                                ...
                                <li class="grid-item fadeInUp" v-for="teacher in teachers">
                                    <a :href="`/profile/${teacher.id}`">
                                        <figure>
                                            <div class="portfolio-img bg-extra-dark-gray"><img :src="teacher.promo_img"
                                                                                               alt=""
                                ...
                                <infinite-loading @infinite="append" spinner="waveDots" ref="infiniteLoading">
                                    <span slot="no-more">
                                      Больше никого нет :(
                                    </span>
                    ...
                    <div class="col-md-12">
                        <button class="btn btn-block btn-large btn-black" v-show="distance < 0" @click="manualLoad">
                            <span v-if="!busy">
                            Загрузить ещё
                            </span>
                            <span v-if="busy">
