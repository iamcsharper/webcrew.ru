...
function init_scroll_navigate() {
	...
	$(".navbar-nav li a.active").each(function(){$(this).removeClass('active');});
	var menu_lis = $(".navbar-nav li");
...
$(document).ready(function () {
    ...
    $('.navbar-collapse a.dropdown-toggle').on('touchstart', function (e) {
        $('.navbar-collapse a.dropdown-toggle').not(this).parent().removeClass('active');
